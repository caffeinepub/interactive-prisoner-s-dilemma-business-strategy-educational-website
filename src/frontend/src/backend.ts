...
export class Backend implements backendInterface {
    ...
    async getAnalysis(): Promise<{
        ...
        if (this.processError) {
            try {
                const result = await this.actor.getAnalysis();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getPayoffMatrix(): Promise<PayoffMatrix> {
        if (this.processError) {
            try {
                const result = await this.actor.getPayoffMatrix();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async runOneShot(arg0: string, arg1: string): Promise<SimulationResult> {
        if (this.processError) {
            try {
                const result = await this.actor.runOneShot(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async runRepeatedGame(arg0: string, arg1: string, arg2: bigint): Promise<SimulationResult> {
        if (this.processError) {
            try {
                const result = await this.actor.runRepeatedGame(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updatePayoffMatrix(arg0: PayoffMatrix): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updatePayoffMatrix(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
